...
const sessdata = config.SESSION_ID.replace("𝗛𝗜𝗥𝗨-𝗫-𝗠𝗗 𝗩𝟭=", '');
...
*© 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗕𝘆 𝗛𝗶𝗿𝘂 𝗫 𝗠𝗱*`;
    ...
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/cp10r1.jpg` }, caption: up })
  }
  })
